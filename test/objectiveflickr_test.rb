...
class ObjectiveFlickrTest < Minitest::Test
  ...
  def test_corrupt_key
    ...
    assert_equal(e.message, "Invalid API Key (Key not found)", "error message should be 'invalid API key'")
  end

  def test_deprecated_photo_helpers
    params = {:server=>1234, :id=>5678, :secret=>90, :farm=>321}
    assert_equal(@f.photo_url(params), "https://farm321.static.flickr.com/1234/5678_90.jpg", "URL helper failed")
  ...
  def test_photo_helpers
    ...
    assert_equal(FlickrPhoto.url_from_hash(params), "https://static.flickr.com/1234/5678_90.jpg", "URL helper failed")
    params[:farm] = "321"
    assert_equal(FlickrPhoto.url_from_hash(params), "https://farm321.static.flickr.com/1234/5678_90.jpg", "URL helper failed")
    params[:farm] = nil
    ...
    params[:size] = 'o'
    assert_equal("https://farm321.static.flickr.com/1234/5678_9999_o.png", FlickrPhoto.url_from_hash(params), "URL helper failed")

  end

  def test_buddy_icons
    assert_equal FlickrPhoto.buddy_icon_url("12345678@N1234"), "https://www.flickr.com/images/buddyicon.jpg"
    assert_equal FlickrPhoto.buddy_icon_url("12345678@N1234", "92"), "https://static.flickr.com/92/buddyicons/12345678@N1234.jpg"
    assert_equal FlickrPhoto.buddy_icon_url("12345678@N1234", "92", "1"), "https://farm1.static.flickr.com/92/buddyicons/12345678@N1234.jpg"
  end
end
